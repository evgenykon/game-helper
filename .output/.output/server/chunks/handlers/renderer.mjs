...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Game Helper: Monopoly"},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/svg","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"Game Helper"};
